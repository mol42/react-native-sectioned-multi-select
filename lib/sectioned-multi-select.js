...
class SectionedMultiSelect extends PureComponent {
  ...
  static defaultProps = {
    ...
    styles: {},
    colors: {},
    itemFontFamily: { fontFamily: Platform.OS === 'android' ? 'normal' : 'Avenir' },
    subItemFontFamily: { fontFamily: Platform.OS === 'android' ? 'normal' : 'Avenir' },
    searchTextFontFamily: { fontFamily: Platform.OS === 'android' ? 'normal' : 'Avenir'},
    confirmFontFamily: { fontFamily: Platform.OS === 'android' ? 'normal' : 'Avenir'},
